...
<p align="center">
   ...
   <a href="https://git.io/typing-svg"><img width=350 src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&pause=1000&color=267CB9&center=true&vCenter=true&random=true&width=435&lines=Aspiring+Data+Science+Professional+;4+Yrs+of+Software+Engineer+Experience;DS+%7C+ML+%7C+AI+Enthusiast" alt="Typing SVG" /></a>
    <p align="center"><b>
        (Open for hiring!)
    </b></p>
</p>
...
<p style="text-align: justify;
  text-justify: inter-word;">
    I’m a software engineer with over <b>four</b> years of experience and a Master’s in Data Science and Analytics from the University of Hertfordshire. My journey began in full stack web application development and has evolved into building practical AI systems that solve real-world problems.
    <br>
    Along the way, I’ve built scalable APIs, deployed machine learning pipelines, and worked on projects ranging from semantic search to real-time alerting systems. I enjoy working at the intersection of software and data, where curiosity and engineering come together to build something meaningful.
    <br>
    I’m always learning, always building, and always looking for ways to apply technology in impactful ways.
    <br>
</p>
...
### [AlertOps AI: DevOps Log Classification & Alert Automation System](https://github.com/shekar-raja/alertops-ai)

- Designed and implemented an end-to-end log observability system to automatically classify system alerts into priority levels (P1-P4) and trigger appropriate actions.
- Built a scalable ML pipeline including real-time data ingestion (Kafka), log pre-processing, feature engineering, and model training (Random Forest, XGBoost, LSTM).
- Deployed trained ML models to Azure ML, enabling scalable, cloud-based inference and ensuring consistent performance in production.
- Automated alert classification using Machine Learning and NLP techniques, reducing manual triaging efforts and accelerating incident resolution.
